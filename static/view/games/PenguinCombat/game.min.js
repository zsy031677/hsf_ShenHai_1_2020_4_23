...
try{var p=c.localStorage=d.localStorage;p.setItem("storage","");p.removeItem("storage");p=null}catch(r){("SECURITY_ERR"===r.name||"QuotaExceededError"===r.name)&&cc.warn("Warning: localStorage isn't enabled. Please confirm browser cookie or privacy option"),c.localStorage=function(){}}
...
c[d.renderMode];b._prepareCalled=!0;var g=c[d.jsList]||[];cc.Class?f.loadJsWithImg("",g,function(c){if(c)throw c;b._prepared=!0;a&&a()}):(d=cc.path.join(e,"moduleConfig.json"),f.loadJson(d,function(d,f){if(d)throw d;var m=c.modules||[],n=f.module,p=[];cc._renderType===cc._RENDER_TYPE_WEBGL?m.splice(0,0,"shaders"):0>m.indexOf("core")&&m.splice(0,0,"core");for(var r=0,s=m.length;r<s;r++){var u=b._getJsListOfModule(n,m[r],e);u&&(p=p.concat(u))}
...
var e=this.prototype,f=Object.create(e),g=ClassManager.getNewID();ClassManager[g]=e;var h={writable:!0,enumerable:!1,configurable:!0};f.__instanceId=null;d.id=g;h.value=g;Object.defineProperty(f,"__pid",h);d.prototype=f;h.value=d;Object.defineProperty(d.prototype,"constructor",h);this.__getters__&&(d.__getters__=cc.clone(this.__getters__));this.__setters__&&(d.__setters__=cc.clone(this.__setters__));for(var k=0,m=arguments.length;k<m;++k){var n=arguments[k],p;for(p in n){var r="function"===typeof n[p],s="function"===typeof e[p],u=a.test(n[p]);b&&r&&s&&u?(h.value=ClassManager.compileSuper(n[p],p,g),Object.defineProperty(f,p,h)):r&&s&&u?(h.value=function(a,b){return function(){var c=this._super;this._super=e[a];var d=b.apply(this,arguments);this._super=c;return d}}(p,n[p]),Object.defineProperty(f,p,h)):r?(h.value=n[p],Object.defineProperty(f,p,h)):f[p]=n[p];if(r){var t,v;if(this.__getters__&&this.__getters__[p]){var r=this.__getters__[p],w;for(w in this.__setters__)
if(this.__setters__[w]===r){v=w;break}
cc.defineGetterSetter(f,r,n[p],n[v]?n[v]:f[v],p,v)}
if(this.__setters__&&this.__setters__[p]){r=this.__setters__[p];for(w in this.__getters__)
if(this.__getters__[w]===r){t=w;break}
...
if(e=!0,g===h.MOVED&&a.onTouchMoved)a.onTouchMoved(d,c);else if(g===h.ENDED){if(a.onTouchEnded)a.onTouchEnded(d,c);a._registered&&a._claimedTouches.splice(f,1)}else if(g===h.CANCELLED){if(a.onTouchCancelled)a.onTouchCancelled(d,c);a._registered&&a._claimedTouches.splice(f,1)}
...
if(g){e=new Uint16Array(b*c);f=a.getData();for(m=0;m<n;++m)e[m]=(f[m]>>0&255)>>3<<11|(f[m]>>8&255)>>2<<5|(f[m]>>16&255)>>3<<0}else{e=new Uint16Array(b*c);f=a.getData();for(m=0;m<n;++m)e[m]=(f[m]&255)>>3<<11|(f[m]&255)>>2<<5|(f[m]&255)>>3<<0}else if(k===d.PIXEL_FORMAT_RGBA4444){e=new Uint16Array(b*c);f=a.getData();for(m=0;m<n;++m)e[m]=(f[m]>>0&255)>>4<<12|(f[m]>>8&255)>>4<<8|(f[m]>>16&255)>>4<<4|(f[m]>>24&255)>>4<<0}else if(k===d.PIXEL_FORMAT_RGB5A1){e=new Uint16Array(b*c);f=a.getData();for(m=0;m<n;++m)e[m]=(f[m]>>0&255)>>3<<11|(f[m]>>8&255)>>3<<6|(f[m]>>16&255)>>3<<1|(f[m]>>24&255)>>7<<0}else if(k===d.PIXEL_FORMAT_A8){e=new Uint8Array(b*c);f=a.getData();for(m=0;m<n;++m)e[m]=f>>24&255}
if(g&&k===d.PIXEL_FORMAT_RGB888){f=a.getData();e=new Uint8Array(3*b*c);for(m=0;m<n;++m)e[3*m]=f>>0&255,e[3*m+1]=f>>8&255,e[3*m+2]=f>>16&255}
...
c=this._textureColorsCache;for(d in c){var e=c[d],f;for(f in e){var g=e[f];a++;cc.log(cc._LogInfos.textureCache_dumpCachedTextureInfo_2,d,g.width,g.height);b+=4*g.width*g.height}}
...
for(var d=c.timers,e=0,f=d.length;e<f;e++){var g=d[e];if(this._getUnscheduleMark(a,g)){g===c.currentTimer&&!c.currentTimerSalvaged&&(c.currentTimerSalvaged=!0);d.splice(e,1);c.timerIndex>=e&&c.timerIndex--;0===d.length&&(this._currentTarget===c?this._currentTargetSalvaged=!0:this._removeHashElement(c));break}}}},unscheduleUpdate:function(a){if(null!=a&&(a=this._hashForUpdates[a.__instanceId]))this._updateHashLocked?a.entry.markedForDeletion=!0:this._removeUpdateFromHash(a.entry)},unscheduleAllForTarget:function(a){if(null!=a){var b=this._hashForTimers[a.__instanceId];b&&(-1<b.timers.indexOf(b.currentTimer)&&!b.currentTimerSalvaged&&(b.currentTimerSalvaged=!0),b.timers.length=0,this._currentTarget===b?this._currentTargetSalvaged=!0:this._removeHashElement(b));this.unscheduleUpdate(a)}},unscheduleAll:function(){this.unscheduleAllWithMinPriority(cc.Scheduler.PRIORITY_SYSTEM)},unscheduleAllWithMinPriority:function(a){var b,c,d=this._arrayForTimers;for(b=0;b<d.length;b++)c=d[b],this.unscheduleAllForTarget(c.target);d=0;if(0>a)
...
0<this._strings.length&&(this._isMultiLine=!0);e=d=0;a._strokeEnabled&&(d=e=2*a._strokeSize);if(a._shadowEnabled){var g=a._shadowOffset;d+=2*Math.abs(g.x);e+=2*Math.abs(g.y)}
...
for(m=3;0<=m;m--)
if(u[m]!==s[m])
for(n=0;4>n;n++)a.swap(n,u[m],n,s[m]);return!0};var c=(new a.math.Matrix4).identity();a.kmMat4Inverse=function(b,d){var g=new a.math.Matrix4(d);if(!1===a.math.Matrix4._gaussj(g,c))return null;b.assignFrom(g);return b};b.inverse=function(){var b=new a.math.Matrix4(this);return!1===a.math.Matrix4._gaussj(b,c)?null:b};b.isIdentity=function(){var a=this.mat;return 1===a[0]&&0===a[1]&&0===a[2]&&0===a[3]&&0===a[4]&&1===a[5]&&0===a[6]&&0===a[7]&&0===a[8]&&0===a[9]&&1===a[10]&&0===a[11]&&0===a[12]&&0===a[13]&&0===a[14]&&1===a[15]};b.transpose=function(){var a=this.mat,b=a[1],c=a[2],d=a[3],k=a[6],m=a[7],n=a[8],p=a[9],r=a[11],s=a[12],u=a[13],t=a[14];a[1]=a[4];a[2]=n;a[3]=s;a[4]=b;a[6]=p;a[7]=u;a[8]=c;a[9]=k;a[11]=t;a[12]=d;a[13]=m;a[14]=r;return this};a.kmMat4Multiply=function(a,b,c){var d=a.mat,k=b.mat,m=c.mat;c=k[0];b=k[1];var n=k[2],p=k[3],r=k[4],s=k[5],u=k[6],t=k[7],v=k[8],w=k[9],y=k[10],z=k[11],x=k[12],A=k[13],B=k[14],k=k[15],C=m[0],D=m[1],E=m[2],F=m[3],G=m[4],H=m[5],I=m[6],J=m[7],K=m[8],L=m[9],M=m[10],N=m[11],O=m[12],P=m[13],Q=m[14],m=m[15];d[0]=C*c+D*r+E*v+F*x;d[1]=C*b+D*s+E*w+F*A;d[2]=C*n+D*u+E*y+F*B;d[3]=C*p+D*t+E*z+F*k;d[4]=G*c+H*r+I*v+J*x;d[5]=G*b+H*s+I*w+J*A;d[6]=G*n+H*u+I*y+J*B;d[7]=G*p+H*t+I*z+J*k;d[8]=K*c+L*r+M*v+N*x;d[9]=K*b+L*s+M*w+N*A;d[10]=K*n+L*u+M*y+N*B;d[11]=K*p+L*t+M*z+N*k;d[12]=O*c+P*r+Q*v+m*x;d[13]=O*b+P*s+Q*w+m*A;d[14]=O*n+P*u+Q*y+m*B;d[15]=O*p+P*t+Q*z+m*k;return a};b.multiply=function(a){var b=this.mat,c=a.mat;a=b[0];var d=b[1],k=b[2],m=b[3],n=b[4],p=b[5],r=b[6],s=b[7],u=b[8],t=b[9],v=b[10],w=b[11],y=b[12],z=b[13],x=b[14],A=b[15],B=c[0],C=c[1],D=c[2],E=c[3],F=c[4],G=c[5],H=c[6],I=c[7],J=c[8],K=c[9],L=c[10],M=c[11],N=c[12],O=c[13],P=c[14],c=c[15];b[0]=B*a+C*n+D*u+E*y;b[1]=B*d+C*p+D*t+E*z;b[2]=B*k+C*r+D*v+E*x;b[3]=B*m+C*s+D*w+E*A;b[4]=F*a+G*n+H*u+I*y;b[5]=F*d+G*p+H*t+I*z;b[6]=F*k+G*r+H*v+I*x;b[7]=F*m+G*s+H*w+I*A;b[8]=J*a+K*n+L*u+M*y;b[9]=J*d+K*p+L*t+M*z;b[10]=J*k+K*r+L*v+M*x;b[11]=J*m+K*s+L*w+M*A;b[12]=N*a+O*n+P*u+c*y;b[13]=N*d+O*p+P*t+c*z;b[14]=N*k+O*r+P*v+c*x;b[15]=N*m+O*s+P*w+c*A;return this};a.getMat4MultiplyValue=function(a,b){var c=a.mat,d=b.mat,k=new Float32Array(16);k[0]=c[0]*d[0]+c[4]*d[1]+c[8]*d[2]+c[12]*d[3];k[1]=c[1]*d[0]+c[5]*d[1]+c[9]*d[2]+c[13]*d[3];k[2]=c[2]*d[0]+c[6]*d[1]+c[10]*d[2]+c[14]*d[3];k[3]=c[3]*d[0]+c[7]*d[1]+c[11]*d[2]+c[15]*d[3];k[4]=c[0]*d[4]+c[4]*d[5]+c[8]*d[6]+c[12]*d[7];k[5]=c[1]*d[4]+c[5]*d[5]+c[9]*d[6]+c[13]*d[7];k[6]=c[2]*d[4]+c[6]*d[5]+c[10]*d[6]+c[14]*d[7];k[7]=c[3]*d[4]+c[7]*d[5]+c[11]*d[6]+c[15]*d[7];k[8]=c[0]*d[8]+c[4]*d[9]+c[8]*d[10]+c[12]*d[11];k[9]=c[1]*d[8]+c[5]*d[9]+c[9]*d[10]+c[13]*d[11];k[10]=c[2]*d[8]+c[6]*d[9]+c[10]*d[10]+c[14]*d[11];k[11]=c[3]*d[8]+c[7]*d[9]+c[11]*d[10]+c[15]*d[11];k[12]=c[0]*d[12]+c[4]*d[13]+
...
if(this._alignment!==cc.TEXT_ALIGNMENT_LEFT){d=a=0;e=this._string.length;f=[];for(g=0;g<e;g++)
...
return null}});_p=cc.Menu.prototype;cc.Menu.create=function(a){var b=arguments.length;0<b&&null==arguments[b-1]&&cc.log("parameters should not be ending with null in Javascript");return 0===b?new cc.Menu:1===b?new cc.Menu(a):new cc.Menu(Array.prototype.slice.call(arguments,0))};var start={STARTBG:"res/start_bg.jpg",PROGRESSBAG:"res/progressbar.png",PROGRESSBG:"res/progressbg.png",STARTBUT:"res/start_but.png"},start_res=[start.STARTBG,start.PROGRESSBAG,start.PROGRESSBG,start.STARTBUT],game={NEWBG:"res/new_bg.png",SELECTBUT:"res/select_but.png",CLOSEBUT:"res/close_but.png",GAMEBG:"res/game_bg.jpg",SP1:"res/sp1.png",SP2:"res/sp2.png",SP3:"res/sp3.png",SP4:"res/sp4.png",SP5:"res/sp5.png",SP6:"res/sp6.png",BALL:"res/ball.png",BOOM1:"res/ballboom1.png",BOOM2:"res/ballboom2.png",BOOM3:"res/ballboom3.png",BOOM4:"res/ballboom4.png",OVERBG:"res/over_bg.png",REPLAYBUT:"res/replay_but.png",MENUBUT:"res/menu_but.png",NUMBER:"res/number.png"},game_res=[game.NEWBG,game.SELECTBUT,game.CLOSEBUT,game.GAMEBG,game.SP1,game.SP2,game.SP3,game.SP4,game.SP5,game.SP6,game.BALL,game.BOOM1,game.BOOM2,game.BOOM3,game.BOOM4,game.OVERBG,game.REPLAYBUT,game.MENUBUT,game.NUMBER];var currentscore=0,bestscore=localStorage.getItem("qebwzbest")||0;function saveDollNum(a){a=JSON.stringify(a);cc.sys.localStorage.setItem("dollNum",a)}
function loadDollNum(){var a=cc.sys.localStorage.getItem("dollNum");return null==a||0==a?!1:!0};var StartScene=cc.Scene.extend({loaderLayer:null,onEnter:function(){this._super();var a=this;cc.loader.loadImg(start.STARTBG,{isCrossOrigin:!1},function(b,c){var d=new cc.Sprite("res/start_bg.jpg");d.setAnchorPoint(0,0);a.addChild(d)});cc.loader.loadImg(start.STARTBUT,{isCrossOrigin:!1},function(b,c){var d=new cc.MenuItemImage("res/start_but.png","res/start_but.png",a.startLoadRes,a);d.setPosition(240,120);d=new cc.Menu(d);d.setPosition(0,0);a.addChild(d,1)})},startLoadRes:function(a){a.parent.removeFromParent();this.loaderLayer||(this.loaderLayer=new ProloadLayer,this.addChild(this.loaderLayer,2));this.loaderLayer.initWithResources(game_res,function(){cc.director.runScene(new GameScene)},this)}});var GameScene=cc.Scene.extend({onEnter:function(){this._super();if(loadDollNum())a=new GameLayer,this.addChild(a),a.startUpdate();else{var a=new GameLayer;a.setPosition(0,0);this.addChild(a);a=new GuideLayer(a);this.addChild(a,2)}}});var PROGRESSBAG="data:image/png;base64,\x3d\x3d",PROGRESSBG="data:image/png;base64,",ProloadLayer=cc.Layer.extend({_interval:null,_label:null,_className:"LoaderScene",cb:null,target:null,progressBar:null,progressBg:null,ctor:function(){this._super();var a=this;PROGRESSBG&&cc.loader.loadImg(PROGRESSBG,{isCrossOrigin:!1},function(b,c){a.progressBg=new cc.Sprite(c);a.progressBg.setPosition(240,120);a.addChild(a.progressBg,1)});PROGRESSBAG&&cc.loader.loadImg(PROGRESSBAG,{isCrossOrigin:!1},function(b,c){a.progressBar=new cc.Sprite(c);a.progressBar.setAnchorPoint(0,0.5);a.progressBar.setPosition(11,17);a.progressBar.setScaleX(0);a.progressBg.addChild(a.progressBar);a.schedule(a.startLoading,0.05)});return!0},onEnter:function(){cc.Node.prototype.onEnter.call(this)},onExit:function(){cc.Node.prototype.onExit.call(this);this.progressBar.setScaleX(1)},initWithResources:function(a,b,c){cc.isString(a)&&(a=[a]);this.resources=a||[];this.cb=b;this.target=c},startLoading:function(){var a=this;a.unschedule(a.startLoading);cc.loader.load(a.resources,function(b,c,d){b=Math.min(d/c,1);a.progressBar.setScaleX(b)},function(){a.progressBar.setScaleX(1);a.scheduleOnce(function(){a.cb&&a.cb.call(a.target)},0.3)})}});var GameLayer=cc.Layer.extend({scoreNumber:null,penguinArray:null,ballsArray:null,boomAc:null,ctor:function(){this._super();this.scoreNumber=0;this.penguinArray=[];this.ballsArray=[];var a=new cc.Sprite(game.GAMEBG);a.setAnchorPoint(0,0);this.addChild(a);this.scoreLabel=new cc.LabelTTF("0","Arial",30);this.scoreLabel.setAnchorPoint(0.5,0.5);this.scoreLabel.setPosition(130,732);this.addChild(this.scoreLabel,3);a=new cc.LabelTTF(String(bestscore),"Arial",30);a.setAnchorPoint(0.5,0.5);a.setPosition(410,710);a.setColor(cc.color(250,212,0));this.addChild(a,3);return!0},onEnter:function(){this._super();this.addSpriteToLayer();this.addBallToLayer()},startUpdate:function(){this.schedule(this.updateSpriteMove,0.01);this.schedule(this.checkCollision,0.05);this.schedule(this.addSpriteToLayer,4)},addSpriteToLayer:function(){for(var a=1;5>=a;a++){var b=Math.floor(cc.rand()%4+1),c=new cc.Sprite(game["SP"+b]);c.type=b;c.setPosition(-350+60*a,570);this.addChild(c,3);this.penguinArray.push(c);4==b&&this.addBoomAcForSprite(c)}},addBoomAcForSprite:function(a){for(var b=new cc.Animation,c=4;6>=c;c++)b.addSpriteFrameWithFile(game["SP"+c]);b.setDelayPerUnit(0.05);b.setLoops(50);b=cc.animate(b);a.runAction(b)},addBallToLayer:function(){var a=new cc.Sprite(game.BALL);this.addChild(a,3);a.setPosition(0,250);var b=new cc.MoveBy(0.5,cc.p(240,0)),c=new cc.RotateBy(0.5,1800);a.runAction(cc.spawn(b,c));this.addTouchForBall(a);this.ballsArray.push(a)},addTouchForBall:function(a){var b=this,c=cc.EventListener.create({event:cc.EventListener.TOUCH_ONE_BY_ONE,swallowTouches:!0,startPos:null,endPos:null,onTouchBegan:function(b,c){return cc.rectContainsPoint(a.getBoundingBox(),b.getLocation())?(this.startPos=b.getLocation(),!0):!1},onTouchEnded:function(d,e){this.endPos=d.getLocation();var f=cc.p(this.endPos.x-this.startPos.x,this.endPos.y-this.startPos.y);!(20>f.x*f.x+f.y*f.y)&&(0<f.y&&Math.abs(f.x)<=f.y)&&(a.rota=f.y/f.x,b.touchSpriteMove(a,c),b.addBallToLayer())}});cc.eventManager.addListener(c,a)},updateSpriteMove:function(){for(var a in this.penguinArray){if(500>this.penguinArray[a].x){this.penguinArray[a].x+=1.5}else{if(this.penguinArray[a]){if(this.penguinArray[a].type!=4){dieFlag=true;}}
this.penguinArray[a].removeFromParent(),this.penguinArray.splice(a--,1)}}},touchSpriteMove:function(a,b){cc.eventManager.removeListener(b);var c=new cc.MoveBy(0.5,cc.p(600/a.rota,600)),d=new cc.CallFunc(function(){a.removeFromParent();var b=this.ballsArray.indexOf(a);this.ballsArray.splice(b,1)},this);a.runAction(cc.sequence(c,d))},checkCollision:function(){for(var a in this.penguinArray)
for(var b in this.ballsArray){if(dieFlag){dieFlag=0;this.unscheduleAllCallbacks();var c=this.ballsArray[b];c.stopAllActions();c.setScale(2);b=new cc.Animation;for(a=1;4>=a;a++)b.addSpriteFrameWithFile(game["BOOM"+a]);b.setDelayPerUnit(0.1);b.setLoops(1);a=cc.animate(b);b=new cc.CallFunc(function(){this.addOverLayerToScene()},this);c.runAction(cc.sequence(a,b))
return}
if(cc.rectIntersectsRect(this.penguinArray[a].getBoundingBox(),this.ballsArray[b].getBoundingBox())){if(4==this.penguinArray[a].type){dieFlag=0;this.unscheduleAllCallbacks();var c=this.ballsArray[b];c.stopAllActions();c.setScale(2);b=new cc.Animation;for(a=1;4>=a;a++)b.addSpriteFrameWithFile(game["BOOM"+a]);b.setDelayPerUnit(0.1);b.setLoops(1);a=cc.animate(b);b=new cc.CallFunc(function(){this.addOverLayerToScene()},this);c.runAction(cc.sequence(a,b))}else this.scoreNumber++,this.scoreLabel.setString(this.scoreNumber),c=this.ballsArray[b],c.id=1,c.stopAllActions(),this.ballsArray.splice(b--,1),b=this.penguinArray[a],b.id=2,b.rota=c.rota,this.penguinArray.splice(a--,1),this.flyAndremove(c),this.flyAndremove(b);return}}},flyAndremove:function(a){if(1==a.id){var b=new cc.MoveBy(0.3,cc.p(600/a.rota,-600)),c=new cc.CallFunc(function(){a.removeFromParent()},this);a.runAction(cc.sequence(b,c))}else{var b=new cc.MoveBy(0.5,cc.p(600/a.rota,600)),d=new cc.RotateBy(0.5,720),c=new cc.CallFunc(function(){a.removeFromParent()},this);a.runAction(cc.sequence(cc.spawn(b,d),c))}},addOverLayerToScene:function(){currentscore=this.scoreNumber;currentscore>bestscore&&(bestscore=currentscore,localStorage.setItem("qebwzbest",bestscore));updateShare(currentscore);Play68.setRankingScoreDesc(currentscore);var a=new OverLayer;this.addChild(a,10)}});var OverLayer=cc.LayerColor.extend({ctor:function(){this._super(cc.color(0,0,20,150));var a=cc.EventListener.create({event:cc.EventListener.TOUCH_ONE_BY_ONE,swallowTouches:!0,onTouchBegan:function(a,b){return!0}});cc.eventManager.addListener(a,this);a=new cc.Sprite(game.OVERBG);a.setPosition(240,470);this.addChild(a);a=new cc.MenuItemImage(game.REPLAYBUT,game.REPLAYBUT,this.replayGame,this);a.setPosition(330,250);var b=new cc.MenuItemImage(game.MENUBUT,game.MENUBUT,this.menuGame,this);b.setPosition(150,250);a=new cc.Menu(a,b);a.setPosition(0,0);this.addChild(a,1);a=new cc.LabelTTF(String(bestscore),"Arial",45);a.setPosition(325,375);this.addChild(a);a=new cc.LabelTTF(String(currentscore),"Arial",45);a.setPosition(325,505);this.addChild(a);return!0},replayGame:function(){cc.director.runScene(new GameScene)},menuGame:function(){Play68.goHome();}});var GuideLayer=cc.LayerColor.extend({gameLayer:null,ctor:function(a){this._super(cc.color(0,0,0,80));this.gameLayer=a;a=new cc.Sprite(game.NEWBG);a.setPosition(240,380);this.addChild(a);a=new cc.MenuItemImage(game.CLOSEBUT,game.CLOSEBUT,this.close,this);a.attr({x:435,y:550});a.setScale(0.9);var b=new cc.MenuItemImage(game.SELECTBUT,game.SELECTBUT,this.nextshow,this);b.attr({x:145,y:225,opacity:0});a=new cc.Menu(a,b);a.setPosition(0,0);this.addChild(a);this.listener=cc.EventListener.create({event:cc.EventListener.TOUCH_ONE_BY_ONE,swallowTouches:!0,onTouchBegan:function(a,b){return!0}});cc.eventManager.addListener(this.listener,this);return!0},close:function(){this.gameLayer.startUpdate();this.removeFromParent()},nextshow:function(a){loadDollNum()?(saveDollNum(0),a.setOpacity(0)):(saveDollNum(1),a.setOpacity(255))}});cc.game.onStart=function(){!cc.sys.isNative&&document.getElementById("cocosLoading")&&document.body.removeChild(document.getElementById("cocosLoading"));cc.view.enableRetina(!0);cc.view.adjustViewPort(!0);cc.view.setDesignResolutionSize(480,800,cc.ResolutionPolicy.SHOW_ALL);cc.view.resizeWithBrowserSize(!0);cc.director.runScene(new StartScene)};cc.game.run();